                    ...
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a class="drop-text" href="index.php">Services</a></li>
                                    <li><a class="drop-text" href="about.php">Our Chefs</a></li>
                                    <li><a class="drop-text" href="index.php">Blog</a></li>
        ...
        <div class="container py-xl-4">
            <div class="row footer-top">
                <div class="col-lg-4 footer-grid_section_1its footer-text">
                    ...
                    <!-- //logo -->
                    <p class="mt-lg-4 mt-3 mb-lg-5 mb-4">Sed ut perspiciatis unde omnis iste natus errorhjhsit lupt atem accursit lupt atem accu dfdsa ntium doloremque laudan tium accu santium dolore.</p>
                    <!-- social icons -->
                    <ul class="top-right-info">
                        <li>
                            <p>Follow As:</p>
